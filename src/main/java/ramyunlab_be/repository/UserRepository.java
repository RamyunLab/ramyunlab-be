...
//    @Query("SELECT u FROM UserEntity u WHERE u.userId = :userId")
    ...
    @Query("SELECT u.userIdx as userIdx, u.userId as userId, u.nickname as nickname, r.reviewContent as reviews, r.rvCreatedAt as rvCreatedAt, r.rvIsReported as rvIsReported, r.rvIdx as rvIdx, u.userDeletedAt as userDeletedAt " +
        "FROM UserEntity u LEFT JOIN u.reviews r " +
